...
def run_genetic_algorithm(population_size, number_generations, dejong_function, number_of_bits, number_of_variables):
    ...
    try:
        ...
        print("Convergence...")
    plot_fitness(population_size, number_generations, dejong_function,
                 prev_best_chromosome, number_of_variables, plot_points)
...
def plot_fitness(population_size, number_generations, dejong_function,
                 best_chromosome, number_of_variables, plot_points):
    ...
    plt.title(f"Plot of Pop size {population_size} for {number_generations} "
              f"Generations using {dejong_function} with {number_of_variables} vars")
